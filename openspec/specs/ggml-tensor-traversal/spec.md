...
GGML tensor traversal capability for iterating over GGML format tensors at block level.
Supports various data types including quantized formats (Q4_0, Q8_0) and non-quantized (F32, F16).
